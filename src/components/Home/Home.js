  ...
  return (
    <section>
      <Container fluid className="home-section" id="home">
        <img src={websitebgBackup} alt="home pic" className="img-fluid"/>
        <div className="home-content">
          <h1>Getting items delivered to your doorsteps conveniently and safely can become a real headache</h1> 
          <h4>Our simple system offers an easy supply chain management plam - each with realistic cost projection,<br/> 
